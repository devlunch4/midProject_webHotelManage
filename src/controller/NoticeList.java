...
//		
//		//2. 메서드 호출
//		List<NoticeVO> list = service.nolistAll();
//		
//		//3. 결과값 저장
//		request.setAttribute("list", list);
//		
//		//4.
//		request.getRequestDispatcher("notice/nolistAll.jsp").forward(request, response);
//	
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//2. 메서드 호출
		List<NoticeVO> list = service.nolistPage(map);
		...
		//4.
		request.getRequestDispatcher("hotel/nolistPage.jsp").forward(request, response);
	}
